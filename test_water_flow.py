from water_flow import water_column_height, pressure_gain_from_water_height, pressure_loss_from_pipe, \
    pressure_loss_from_fittings, reynolds_number, pressure_loss_from_pipe_reduction, conversion
...
"""
                            Expected        approx
Fluid       Quantity        Pressure        Absolute
Velocity    of Fittings     Loss            Tolerance
	0           3               0           0.001
    1.65	    0	            0	        0.001
	1.65	    2	            -0.109	    0.001
    1.75	    2	            -0.122	    0.001
...
"""
                        Expected    approx
Hydraulic   Fluid       Reynolds    Absolute
Diameter	Velocity    Number      Tolerance
    0.048692	0	        0	        1
...
"""
                                                Expected    approx
Larger      Fluid       Reynolds    Smaller     Pressure    Absolute
Diameter	Velocity	Number      Diameter    Loss        Tolerance
...
def test_conversion():
    assert conversion(2) == 0.290076
    assert conversion(5) == 0.72519
